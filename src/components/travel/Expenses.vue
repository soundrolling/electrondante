...
<div class="expenses">
  ...
  <div v-else class="content-container">
    ...
    <div class="section-header">
      <h2>Expenses</h2>
      <button v-if="canManageProject && isCurrentUserTripOwner" @click="openModal" class="btn btn-positive add-button" aria-label="Add new expense">
    ...
    <div v-else class="expenses-list">
      ...
      >
        ...
        <div class="expense-actions">
          <button v-if="canManageProject && isCurrentUserTripOwner" @click="editExpense(expense)" class="btn btn-warning action-button edit-button" aria-label="Edit expense">
            <span class="action-icon">✏️</span>
            <span class="action-text">Edit</span>
          </button>
          
          <button v-if="canManageProject && isCurrentUserTripOwner" @click="deleteExpense(expense)" class="btn btn-danger action-button delete-button" aria-label="Delete expense">
            <span class="action-icon">🗑️</span>
