        ...
        <div v-else class="orientation-picker">
          ...
          <div class="orientation-circle">
            <button
              ...
              :key="angle"
              @click="confirmMicWithOrientation(angle)"
          ...
          <button @click="selectedMicForOrientation = null" class="btn-secondary">← Back</button>
        </div>
      </div>
    </div>
  </div>
...
async function confirmMicWithOrientation(rotation) {
